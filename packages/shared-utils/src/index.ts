import type { GradeBand, GpaResult } from '@goinze/shared-types';

// ============================================================
// @goinze/shared-utils — pure helpers shared across apps
// ============================================================
 ...
 * @param schoolCode  school short code
 * @param deptCode    department code
 * @param serial      running serial for the intake
 */
